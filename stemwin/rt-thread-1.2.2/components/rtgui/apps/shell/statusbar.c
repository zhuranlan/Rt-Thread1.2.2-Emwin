...
void statusbar_init(void)
{
    ...
    /* create start image */
    logo_image  = rtgui_image_create(RESOURCE_PATH"/SD/RESOURCE/LOGO.HDC", RT_FALSE);
    back_image  = rtgui_image_create(RESOURCE_PATH"/SD/RESOURCE/BACK.HDC", RT_FALSE);
    linkup_image  = rtgui_image_create(RESOURCE_PATH"/SD/RESOURCE/LINKUP.HDC", RT_FALSE);
    linkdown_image  = rtgui_image_create(RESOURCE_PATH"/SD/RESOURCE/LINKDOWN.HDC", RT_FALSE);
