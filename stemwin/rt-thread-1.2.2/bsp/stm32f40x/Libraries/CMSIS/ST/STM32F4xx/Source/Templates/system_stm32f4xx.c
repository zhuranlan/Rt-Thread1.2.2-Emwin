...
/*
 ...
 |                   | PE15 <-> FSMC_D12  |
 | PE5  <-> FSMC_A21 | PE6  <-> FSMC_A22  |
 | PE2 <-> FSMC_A23  | PG13 <-> FSMC_A24  | PG14 <-> FSMC_A25 |
 +-------------------+--------------------+
*/
  ...
  GPIOG->MODER   = 0x2a280aaa;
  /* Configure PGx pins speed to 100 MHz */ 
  GPIOG->OSPEEDR = 0x3f3c0fff;
...
/*-- FSMC Configuration ------------------------------------------------------*/
   ...
   RCC->AHB3ENR         = 0x00000001;
    ...
    Timing_write.FSMC_DataSetupTime = 4;     /* [15:8] F2/F4 0~255 HCLK */
    /* [19:16] Time between NEx high to NEx low (BUSTURN HCLK) */
