...
__align(4) uint8_t MemoryBase[MEMORY_MAX_SIZE] ;//__attribute__((at(0X6C000000+512*1024)));

/* 定义一个内存管理表 */
uint16_t MemoryManagementMap[MAP_TABLE_SIZE] ;// __attribute__((at(0X6C000000 +512*1024+ MEMORY_MAX_SIZE)));
